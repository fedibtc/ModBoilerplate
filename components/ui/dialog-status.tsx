...
const Container = styled(
  "div",
  cva(
    "absolute inset-0 bg-white animate-fadeIn"
  )
)(({ props: { className, ...props }, cn }) => <div {...props} className={cn({ className })}/>)
...
)(({ props: { status, className, ...props }, cn }) => <div {...props} className={cn({ status, className })} />)